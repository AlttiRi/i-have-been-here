...
interface WatchOptionsBase {
    /**
     * @deprecated ignored in `@vue-reactivity/watch` and will always be `sync`
     */
    flush?: 'sync' | 'pre' | 'post';
...
declare function watch<T extends Readonly<Array<WatchSource<unknown> | object>>, Immediate extends Readonly<boolean> = false>(sources: T, cb: WatchCallback<MapSources<T>, MapOldSources<T, Immediate>>, options?: WatchOptions<Immediate>): WatchStopHandle;
...
export { WatchCallback, WatchEffect, WatchOptions, WatchOptionsBase, WatchSource, WatchStopHandle, watch, watchEffect };
